...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-icon-input icon="mail" wire:model="form.email" id="email" class="block mt-1 w-full" type="email"
        ...
        <div class="mt-4">
            ...
            <div>
                <x-password-input model="form.password" required autocomplete="current-password" />
            </div>
